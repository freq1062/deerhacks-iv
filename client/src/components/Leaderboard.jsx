...
const demoUsers = [
  ...
  },
  {
    ...
    points: 980,
    tasksCompleted: 5,
    distanceTraveled: 7.3,
  },
  {
    username: "GeoGuru",
    points: 1500,
    tasksCompleted: 8,
    distanceTraveled: 12.6,
  },
  {
    username: "PathFinder",
    points: 620,
    tasksCompleted: 4,
    distanceTraveled: 3.8,
  },
  {
  ...
  },
  {
    ...
    points: 830,
    tasksCompleted: 5,
    distanceTraveled: 5.7,
  },
  {
    username: "DiscoveryPro",
    points: 300,
    tasksCompleted: 2,
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-100">
            <tr>
              <th
                scope="col"
                className="px-4 py-3 text-center text-xs font-medium text-gray-700 uppercase tracking-wider w-12"
              >
                Rank
              </th>
              <th
